...
import { lawmakerVotesByNomination, nominationTitle, nominationVoteIds, type NominationVotes } from "@/db/queries/nominations";
...
export const fetchNominationVoteIds = cache(async () => {
  return nominationVoteIds();
});
